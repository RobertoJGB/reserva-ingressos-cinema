                ...
                <div class="interface">
                    <div class="flex">
                        <div class="txt-topo">
                            ...
                            <p>
                            Bem-vindo a pagina de informacoes do nosso projeto integrador! Aqui, voce vai conhecer os detalhes por tras da criacao da nossa plataforma de cinema, uma solucao full-stack pensada para proporcionar uma experiencia completa e otimizada aos usuarios na hora de reservar ingressos para o cinema. Nosso projeto foi desenvolvido com tecnologias modernas, como Java, HTML e Banco de Dados, para garantir que a plataforma seja robusta, eficiente e facil de usar.
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="interface">
                    ...
                    <div class="flex">
                        <div class="esp-box">
                            ...
                            <h3>Java</h3>
                            <p>O coracao do nosso sistema e construido em Java, uma das linguagens mais poderosas e confiaveis para o desenvolvimento de sistemas robustos. Usamos Java para criar as classes que controlam toda a logica de funcionamento da plataforma.</p>
                        </div>
                        <div class="esp-box">
                            <i class="bi bi-bug"></i>
                            <h3>HTML</h3>
                            <p>No front-end, usamos HTML para criar a estrutura da plataforma, garantindo navegacao intuitiva. Estruturamos a pagina principal para busca de filmes, escolha de horarios e sessoes. A exibicao dos filmes, descricoes, horarios e disponibilidade de assentos e feita de forma clara e objetiva, dando ao usuario uma visao completa de sua escolha.</p>
                        </div>
                        <div class="esp-box">
                            <i class="bi bi-window-sidebar"></i>
                            <h3>Banco de Dados</h3>
                            <p>Para organizar e acessar facilmente as informacoes, usamos um banco de dados relacional, onde armazenamos dados sobre filmes, sessoes e assentos disponiveis. Registramos as reservas e preferencias dos usuarios, garantindo seguranca nas transacoes e mantendo o historico de compras.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section class="tecnologias" id="habilidades">
                        <div class="interface">
                            ...
                            <div class="flex">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <div class="tec-box">
                                    <svg  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
                                        <g fill="#5c6f7d" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><g transform="scale(5.12,5.12)"><path d="M45.274,2.325c-0.19,-0.207 -0.457,-0.325 -0.738,-0.325h-39.072c-0.281,0 -0.548,0.118 -0.738,0.325c-0.19,0.207 -0.283,0.485 -0.258,0.764l3.52,39.427c0.037,0.412 0.324,0.759 0.722,0.873l16.01,4.573c0.089,0.025 0.182,0.038 0.274,0.038c0.092,0 0.185,-0.013 0.274,-0.038l16.024,-4.573c0.398,-0.114 0.685,-0.461 0.722,-0.873l3.518,-39.427c0.025,-0.279 -0.069,-0.557 -0.258,-0.764zM12,29.004l7,1.942v-19.946h4v26l-11,-3.051zM38.054,22l-1.054,12.25l-10,2.75v-4.601l6.75,-1.855l0.25,-3.75l-7,1.206v-17h12l-0.345,4h-7.655v8z"></path></g></g>
                                        </svg>
                                    <h3>JS</h3>
                                </div>
                                <div class="tec-box">
                                    <svg  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
                                        <g fill="none" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><g transform="scale(5.33333,5.33333)"><path d="M41,5h-34l3,34l14,4l14,-4l3,-34z" fill="#5c6f7d"></path><path d="M24,8v31.9l11.2,-3.2l2.5,-28.7z" fill="#5c6f7d"></path><path d="M33.1,13h-9.1v4h4.9l-0.3,4h-4.6v4h4.4l-0.3,4.5l-4.1,1.4v4.2l7.9,-2.6l0.7,-11.5v0z" fill="#000000"></path><path d="M24,13v4h-8.9l-0.3,-4zM19.4,21l0.2,4h4.4v-4zM19.8,27h-4l0.3,5.5l7.9,2.6v-4.2l-4.1,-1.4z" fill="#000000"></path></g></g>
                                        </svg>
                                    <h3>CSS</h3>
                                </div>
                                <div class="tec-box">
                                    <svg  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
                                    <g fill="#5c6f7d" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal"><g transform="scale(5.12,5.12)"><path d="M45.27344,2.32422c-0.1875,-0.20703 -0.45703,-0.32422 -0.73828,-0.32422h-39.07031c-0.28125,0 -0.55078,0.11719 -0.73828,0.32422c-0.19141,0.20703 -0.28516,0.48438 -0.25781,0.76563l3.51953,39.42578c0.03516,0.41406 0.32422,0.75781 0.72266,0.875l16.01172,4.57031c0.08594,0.02734 0.17969,0.03906 0.27344,0.03906c0.09375,0 0.18359,-0.01172 0.27344,-0.03906l16.02344,-4.57031c0.39844,-0.11719 0.68359,-0.46094 0.72266,-0.875l3.51563,-39.42578c0.02734,-0.28125 -0.06641,-0.55859 -0.25781,-0.76562zM36.84766,15.91797h-18.8125l0.44922,5.08984h17.91016l-1.34375,15.04297l-10.05859,3.03906l-0.09766,-0.03125l-9.94141,-3.01172l-0.54297,-6.12891h4.87109l0.21094,2.37891l5.55859,1.16406l5.45703,-1.16406l0.58203,-6.4375h-17.04297l-1.32422,-14.80469h24.55859z"></path></g></g>
                                </svg>
                                    <h3>HTML</h3>
                                </div>
                            </div>
